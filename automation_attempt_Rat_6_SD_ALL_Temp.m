...
root_rat= '/media/irene/MD04_RAT_THETA/Spike_sorting/Rat_OS_Ephys_RGS14_rat6_373726';
...
RAT_6_TEMP_SD_BEST_WFM= Stored_WFMs;
save('/home/irene/Downloads/RGS14_all_Shekhar/Code/RAT_6_TEMP_SD_BEST_WFM');         
et=toc/60;
disp(strcat('Run time in minutes:',string(et)))
% sendmail('relativelygenius1111@gmail.com',strcat('Rn',root_rat(k1+4)))