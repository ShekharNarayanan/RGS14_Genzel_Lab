function [handles,datavar_collection] = plotSpread(varargin)
...
for iData = 1:nData
    ...
    datavar_collection=[datavar_collection {currentData}];
end
            ...
            switch opt.xyOri
                case 'normal'
                    ph(iData,iCategory) = plot(ah,data(currentIdx,1),...
                        data(currentIdx,2),...
                        'marker',plotMarkers{iData,iCategory},'MarkerSize',25,...
