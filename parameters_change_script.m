...
gwfparams.dataDir='/home/irene/Downloads/RGS14_all/Tetrodes/Tetrode_8/phy_AGR';
...
for curUnitInd=1:numUnits %from 1 to 8
 ...
 for Unit=1:numUnits 
        subplot(4,4,Unit)
        plot(((0:length(WFM_4(:,:,Unit))-1))/30000*1000,WFM4(:,:,Unit))
        xlabel('millisecond');
...
%WFM_ALL=[WFM_1;WFM_2;WFM_3;WFM_4];
