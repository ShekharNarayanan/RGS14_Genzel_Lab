function Final_Rat_Struct=Firing_Rate_Trials(Sleep_Scoring_Directory_For_Rat,Spike_Corrected_WFM)
...
PS=[];T1=[];PT1=[];T2=[];PT2=[];T3=[];PT3=[];T4=[];PT4=[];T5=[];PT5=[]; PT5_1=[];PT5_2=[];PT5_3=[];PT5_4=[];
