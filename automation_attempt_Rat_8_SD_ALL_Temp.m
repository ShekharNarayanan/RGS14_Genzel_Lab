...
root_rat= '/media/irene/GL13_RAT_BURSTY/Spike_sorting/Rat_OS_Ephys_RGS14_rat8_378133';
      ...
      for folder=1:length(tetrodes)
          ...
          for channel_index=1:length(Channels_array)
              ...
              for curUnitInd=1:numUnits %from 1 to 8
                  ...
                  W_temp(curUnitInd,channel_index).WFM_Titles=strcat('RGS_PROJECT_RGS14_PFC','_','Rn',R(k1(1)+4),'_',string(name_exp_cond_final),'_','SD',string(study_day),'_','T',string(T{1}{2}),'_','UID',string(curUnitID),'_','C',string(channel_index));%%k2(1),k1, T(2) may give array indexing errors; best to check their contents
...
RAT_8_TEMP_SD_BEST_WFM= Stored_WFMs;
save('/home/irene/Downloads/RGS14_all_Shekhar/Code/RAT_8_TEMP_SD_BEST_WFM'); 
