...
Result_Matrix=[A.Wave_Matrix_Data,B.Wave_Matrix_Data,C.Wave_Matrix_Data,D.Wave_Matrix_Data,E.Wave_Matrix_Data,F.Wave_Matrix_Data,G.Wave_Matrix_Data]; 
...
%%
    ...
    ELike = ELike';
% end
%Avg_Firing_Rate_Classification;
