...
root_rat= '/media/irene/MD04_RAT_SPIKE/rat/Rat_OS_Ephys_RGS14/Spike_sorting/Rat_OS_Ephys_RGS14_rat3_357152';
...
%             waveFormsMean = nan(nChInMap,wfNSamples,numUnits);%[1 82 8]
            ...
            for curUnitInd=1:numUnits %from 1 to 8
                ...
                W_temp(curUnitInd,channel_index).title=strcat('WFM','_','Rn',R(k1+4),'_','SD',R(k2(1)+3),'_','T',string(T{1}{2}),'_','UID',string(curUnitID),'_','C',string(channel_index));%%k2(1),k1, T(2) may give array indexing errors; best to check their contents 
...
RAT_3_ALL_BEST_WFM= Stored_WFMs;
%save('/home/irene/Downloads/RGS14_all/Code/RAT_3_ALL_BEST_WFM');         
et=toc/60;
